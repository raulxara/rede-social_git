	...
	class Painel
	{
		...
		public static function alert($tipo,$mensagem){
			if($tipo == 'sucesso'){
				...
				echo '<div class="box-alert atencao"><i class="fa-solid fa-triangle-exclamation"></i> '.$mensagem.'</div>';
			}
		}
		...
		public static function senhaForte($senha){
			...
			if(preg_match('/[A-Z]{1,}[a-z]{1,}[0-9]{1,}/', $senha)){
				return true;
			}else{
				return false;
			}
		...
		public static function senhaForte2($senha){
			$senha = $_POST['senha'];
			if(preg_match('/[A-Z]{1,}[a-z]{1,}[0-9]{1,}/', $senha)){
				return true;
			}else{
